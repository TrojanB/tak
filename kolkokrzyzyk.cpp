...
public:
     ...
     int sprawdz(){
        ...
        else if(tab[0]==x && tab[3]==x && tab[6]==x) return x;
        else if(tab[1]==x && tab[4]==x && tab[7]==x)return x;
        else if(tab[2]==x && tab[5]==x && tab[8]==x)return x;

        else if(tab[0]==x && tab[1]==x && tab[2]==x) return x;
        else if(tab[3]==x && tab[4]==x && tab[5]==x) return x;
        else if(tab[6]==x && tab[7]==x && tab[8]==x) return x;

        else if(tab[0]==x && tab[4]==x && tab[8]==x) return x;
        else if(tab[6]==x && tab[4]==x && tab[2]==x) return x;
